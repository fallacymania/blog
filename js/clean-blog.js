            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    $('#success > .alert-success')
                        .append("<strong>Ваше сообщение отослано. </strong>");
                    $('#success > .alert-success')
                        .append('</div>');
                ...
                error: function() {
                    ...
                    $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .alert-danger').append("<strong>Приносим извинения, " + firstName + ", похоже что сервер передачи сообщений сейчас не функционирует! Повторите попытку позже.");
